...
void readTemperature(struct Temperature* data) {
	...
	while (1) {
		...
		if (HAL_ADC_PollForConversion(&hadc1, 1) != HAL_OK) {
			...
			HAL_Delay(120);  //120 milisecond minutes of delay before next reading
		}
...
static void MX_GPIO_Init(void) {
	...
	/*Configure GPIO pin Output Level */
	HAL_GPIO_WritePin(GPIOB, SSD1331_CS_Pin | SSD1331_DC_Pin | SSD1331_RES_Pin,
			GPIO_PIN_RESET);
	...
	/*Configure GPIO pins : SSD1331_CS_Pin SSD1331_DC_Pin SSD1331_RES_Pin */
	GPIO_InitStruct.Pin = SSD1331_CS_Pin | SSD1331_DC_Pin | SSD1331_RES_Pin;
	GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
	GPIO_InitStruct.Pull = GPIO_NOPULL;
	GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;

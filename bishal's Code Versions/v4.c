...
void readTemperature(struct Temperature *data) {
    ...
    uint32_t delayInterval = 180000; // 3 minutes delay by default
	...
	while (1) {
        ...
        if (buttonState == GPIO_PIN_RESET) {
            ...
            ssd1331_display_string(15, 35, "Refreshing", FONT_1206, GREY);
            HAL_Delay(100);
            ssd1331_display_string(40, 45, ".", FONT_1206, GREY);
            HAL_Delay(200);
            ssd1331_display_string(45, 45, ".", FONT_1206, GREY);
            HAL_Delay(300);
            ssd1331_display_string(50, 45, ".", FONT_1206, GREY);
            delayInterval = 1; // Set a short delay for immediate update
        } else {
            // Button is not pressed, turn off LD3_PIN
            HAL_GPIO_WritePin(GPIOB, LD3_Pin, GPIO_PIN_RESET);
            delayInterval = 180000; // Set the default delay for 3 minutes
        }

...
void readTemperature() {
	...
	while (1) {
		...
		if (HAL_ADC_PollForConversion(&hadc1, 1) != HAL_OK) {
			...
			Temperature.adcPinValue = HAL_ADC_GetValue(&hadc1);



			Temperature.temp = tempCalibration(Temperature.adcPinValue);
			printf("Temp: %.1fC", Temperature.temp);

			sprintf(Temperature.msg, "Temp:%.1fC", Temperature.temp);
			ssd1331_display_string(36, 0, Temperature.msg, FONT_1206, GOLDEN);
			...
			HAL_Delay(120000);  //3 minutes of delay before next reading
		}
